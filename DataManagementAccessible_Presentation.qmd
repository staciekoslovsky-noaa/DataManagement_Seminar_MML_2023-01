...
-   Define data management workflowand data manager/scientist role.
...
![](docs/DataManagementAccessible_files/images/data_are_plural.jpg){fig-align="center"}

## 2020 NOAA Data Strategy {.smaller}

::: columns
::: {.column width="25%"}
![](docs/DataManagementAccessible_files/images/noaa_data_strategy.png)
:::
...
## 2024 NOAA Data Management Handbook {.smaller}

::: columns
::: {.column width="25%"}
![](docs/DataManagementAccessible_files/images/noaa-_data_workflow.png)
:::

::: {.column width="75%"}
"This Handbook is designed to provide NOAA data practitioners the requirements, metrics, and procedures and/or best practices to follow in alignment with the laws, regulations, memoranda, and strategic plans. The scope of this document includes procedures to manage data throughout the data life cycle from data planning, obtaining data through long-term preservation and broad data access, but does not include data security, data collection planning or execution, or data quality control. The procedures apply to all NOAA Line Offices and Staff Offices, including affiliates and grantees funded with NOAA resources."
:::
:::
...
## Staff Engagement in Data Management
...
![](docs/DataManagementAccessible_files/images/planning.jpg){fig-align="center"}
...
![](docs/DataManagementAccessible_files/images/sample_folder_structure_personal.png){fig-align="center"}
:::
...
![](docs/DataManagementAccessible_files/images/sample_folder_network_1.png)
:::

::: {.column width="33%"}
**Subfolders within...Data**

![](docs/DataManagementAccessible_files/images/sample_folder_network_2.png)
:::

::: {.column width="33%"}
**...ProgramMgmt & Projects**

![](docs/DataManagementAccessible_files/images/sample_folder_network_3.png)
:::
:::
...
For larger groups (at the program- or project-scale), I'd recommend organizing a centralized folder system and sharing within that, but either way, it's a good conversation to have. New Google Shared Drives are an option for shared spaces without "ownership" by a single individual.

## Plan: Google Drive Organization {.smaller}

**PEP Centralized Google Drive Folder Structure**

![](docs/DataManagementAccessible_files/images/pepGoogleDrive.png){fig-align="center"}
...
::: {.column width="30%"}
![](docs/DataManagementAccessible_files/images/to_do_list.jpg)
:::
:::
...
## Obtain/Collect: Data Collection Template
...
![](docs/DataManagementAccessible_files/images/coastal_data_1.png)
...
![](docs/DataManagementAccessible_files/images/coastal_data_2.png)
...
![](docs/DataManagementAccessible_files/images/sample_results_wide.png)
:::

::: {.column width="50%"}
**Long Format** (preferred)

![](docs/DataManagementAccessible_files/images/sample_results_long.png)
:::
:::
...
![](docs/DataManagementAccessible_files/images/database_schemas.png)
:::
:::

## Obtain/Collect: Example #1 (glacial database) {.smaller}

**PostgreSQL Database Structure** (data are atomized within fields and link across tables)

![](docs/DataManagementAccessible_files/images/glacial_backEnd.png){fig-align="center"}

## Obtain/Collect: Example #1 (glacial database) {.smaller}

**Data Entry Forms** (in Access)

![](docs/DataManagementAccessible_files/images/glacial_dataEntry.png){fig-align="center"}

## Obtain/Collect: Example #1 (glacial database) {.smaller}

**Process Tracking** (in Access)

![](docs/DataManagementAccessible_files/images/glacial_processTracking.png){fig-align="center"}

## Obtain/Collect: Example #1 (glacial database) {.smaller}

**Dataset Tracking** (in Access)

![](docs/DataManagementAccessible_files/images/glacial_datasetTracking.png){fig-align="center"}
...
## Process/Assure: Example #1 (in-field report) {.smaller}

Review field data to ensure there were no issues with initial data collection...

::: columns
::: {.column width="50%"}
![](docs/DataManagementAccessible_files/images/bodyConditionReport_1.png)
:::

::: {.column width="50%"}
![](docs/DataManagementAccessible_files/images/bodyConditionReport_2.png)
:::
:::

## Process/Assure: Example #2 (in database) {.smaller}
...
![](docs/DataManagementAccessible_files/images/database_queries.png){fig-align="center"}
...
![](docs/DataManagementAccessible_files/images/inPort.png){fig-align="center"}

## Describe: Example #2 (dashboard) {.smaller}

**Project management tracking within PEP dashboard**

![](docs/DataManagementAccessible_files/images/pep_dashboard.png){fig-align="center"}

## Describe: Example #3 (GitHub) {.smaller}

**Project management on GitHub** (developed by Josh London)

![](docs/DataManagementAccessible_files/images/gitHub_harborSeals.png){fig-align="center"}
...
![](docs/DataManagementAccessible_files/images/agol.png){fig-align="center"}

## Discover: Example #2 (Shiny App) {.smaller}

**Interactive application** (for exploring harbor seal abundance estimates)

![](docs/DataManagementAccessible_files/images/coastalPv_ShinyApp.png)
...
![](docs/DataManagementAccessible_files/images/pepDataConnect.png){fig-align="center"}
...
## Staff Engagement in Data Management Part II {.smaller}

Make data management practices more friendly to and considerate of everyone within a project/program:
...
## Staff Engagement in Data Management Part II
...
-   Are we ensuring that our data are accessible from an equity perspective?Aerial Harbor Seal Surveys Example...
...
-   Human Error
    ...
    -   This is a step we must expect and consider
...
![](docs/DataManagementAccessible_files/images/hierarchy_of_needs.png){fig-align="center"}
